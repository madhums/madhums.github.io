...
I help startups, non-profits and communities with their digital presence and scaling, so that it reaches the masses who find it meaningful and engaging. For this, I use web and mobile technologies.
...
I use [Open Source Software](https://en.wikipedia.org/wiki/Open-source_software) (OSS) to implement the solutions. I can program in `Ruby`, `JavaScript`, `Typescript`, `Python` (and more) languages. I have used many frameworks, databases, technologies and services.
